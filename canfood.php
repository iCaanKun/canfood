...
$headers[] = 'X-Location: -6.405821,106.064193';
        ...
        echo "\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\e[92m|            Powered by Sad Boys Team            |\n";
        echo "\e[92m|          Nuyul + Nuyul = KENYANG xixi          |\n";
        echo "\e[92m|      https://github.com/iCaanKun/canfood       |\n";
        echo "\e[92m|   SCRIPT GOJEK AUTO REGIST + AUTO SAVE TOKEN   |\n";
        echo "\e[92m|        MOGA CEPET MAKAN ENAK BRO HEHE          |\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\n";
        ulang:
